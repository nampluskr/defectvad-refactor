...
def parse_args():
    ...
    parser.add_argument("--output_dir", "-o", type=str, help="Output directory for predictions and visualizations")
    parser.add_argument("--batch_size", "-b", type=int, default=16, help="Batch size for inference (default: 16)")
    parser.add_argument("--threshold", type=float, default=None, help="Custom decision threshold override")
    parser.add_argument("--no_vis", action="store_true", help="Disable saving visualization images")
