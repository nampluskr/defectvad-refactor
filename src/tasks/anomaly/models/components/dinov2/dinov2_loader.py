...
from src.tasks.anomaly.models.components.data.utils.download import DownloadInfo, DownloadProgressBar
from src.tasks.anomaly.models.components.dinov2 import vision_transformer as dinov2_models
