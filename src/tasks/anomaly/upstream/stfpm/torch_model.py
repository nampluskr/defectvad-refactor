...
from src.tasks.anomaly.upstream.components.feature_extractors.timm import TimmFeatureExtractor

from .anomaly_map import AnomalyMapGenerator

if TYPE_CHECKING:
    from src.tasks.anomaly.upstream.components.tiler import Tiler
